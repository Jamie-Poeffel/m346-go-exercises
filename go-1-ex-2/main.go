...
func main() {
	...
	var marathonInMiles = (marathonInKM * 0.60934) // TODO: calculate using mileInKM!

	fmt.Printf("a marathon is %.2f kilometres = %.2f miles long\n", marathonInKM, marathonInMiles)

	var boilingWaterCelsius = 100.0
	var boilingWaterFahrenheit = (boilingWaterCelsius / 5 * 9) + 32 // TODO: calculate using formula above!
